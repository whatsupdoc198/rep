...
public class lab13Test 
{
	...
	public void setUp() throws Exception 
	{
		...
		try
		{
			...
			ArrayList<Integer> mini1 = testData.get(0);

			for (Integer a = 0; a <mini1.size(); a ++){
				expectedResult1[a] = mini1.get(a);
			}
			...
			ArrayList<Integer> mini2 = testData.get(1);

			for (Integer a = 0; a <mini2.size(); a ++){
				expectedResult2[a] = mini2.get(a);
			}
			...
			ArrayList<Integer> mini3 = testData.get(2);

			for (Integer a = 0; a <mini3.size(); a ++){
				expectedResult3[a] = mini3.get(a);
			}
	...
	void testGetTotalCount(){
        assertEquals( (long) 1000, lab.getTotalCount());
    }

	@Test
    void testGetOddCount(){
        assertEquals((long) 507, lab.getOddCount());

    }

	@Test
	void testGetEvenCount(){
        assertEquals((long) 493, lab.getEvenCount());
    }

	@Test
    void testGetDistinctGreaterThanFiveCount(){
        assertEquals((long) 94, lab.getDistinctGreaterThanFiveCount());
    }

	@Test
    void testGetResult1(){
        assertEquals(expectedResult1, lab.getResult1());
    }

	@Test
    void testGetResult2(){
        assertEquals(expectedResult2, lab.getResult2());
    }

	@Test
    void testGetResult3(){
        assertEquals(expectedResult3, lab.getResult3());
    }
}
